<template>
  <div class="article-add" v-loading.fullscreen.lock="fullscreenLoading">
...
let uploadPictureHost = ref(import.meta.env.VITE_APP_BASE_API + "/file/upload");
let article = ref({
  avatar: "",
  title: "",
  isOriginal: 1,
...
let articleId = ref(route.query.id);
let tagList = ref([]);
let videoInput = ref("");
let rules = {
