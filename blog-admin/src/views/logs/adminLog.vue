  ...
  <div class="app-container">
    <el-card shadow="never" class="table-container">
      ...
      >
        ...
        >
          <template #scope>
            <el-tag v-if="scope.row.type === 'POST'" type="success">{{
              scope.row.type
            }}</el-tag>
            <el-tag v-if="scope.row.type === 'DELETE'" type="danger">{{
              scope.row.type
            }}</el-tag>
            <el-tag v-if="scope.row.type === 'GET'">{{
              scope.row.type
            }}</el-tag>
            <el-tag v-if="scope.row.type === 'PUT'" type="warning">{{
              scope.row.type
            }}</el-tag>
          </template>
        </el-table-column>
